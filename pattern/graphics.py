...
# for drawing the scondary pattern features
...
# Helper function to convert secondary pattern array to annotation
# and visualize it
def visualize_secondary_structure(sse, first_id, linesize=200):
    ...
    # Find the intervals for each secondary pattern element
    ...
    for i in range(len(sse)):
        if curr_start is None:
            ...
            if sse[i] != sse[i - 1]:
                ...
                curr_start = i
                curr_sse = sse[i]
    # Add last secondary pattern element to annotation
